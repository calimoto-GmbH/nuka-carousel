...
function (_React$Component) {
  ...
  function Carousel() {
    ...
    _this.getListStyles = _this.getListStyles.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getFrameStyles = _this.getFrameStyles.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getSlideStyles = _this.getSlideStyles.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getSlideTargetPosition = _this.getSlideTargetPosition.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _this.formatChildren = _this.formatChildren.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(Carousel, [{
    ...
    value: function getSlideStyles(index, positionValue) {
      ...
      return _ref = {
        ...
        height: 'fit-content'
      }, _defineProperty(_ref, "height", index === this.state.currentSlide ? "auto" : "0px"), _defineProperty(_ref, "minHeight", "initial"), _defineProperty(_ref, "boxSizing", 'border-box'), _defineProperty(_ref, "MozBoxSizing", 'border-box'), _defineProperty(_ref, "marginLeft", this.props.vertical ? 'auto' : this.props.cellSpacing / 2), _defineProperty(_ref, "marginRight", this.props.vertical ? 'auto' : this.props.cellSpacing / 2), _defineProperty(_ref, "marginTop", this.props.vertical ? this.props.cellSpacing / 2 : 'auto'), _defineProperty(_ref, "marginBottom", this.props.vertical ? this.props.cellSpacing / 2 : 'auto'), _ref;
    }
  }, {
    ...
    value: function renderControls() {
      ...
      return this.controlsMap.map(function (_ref2) {
        var func = _ref2.func,
            key = _ref2.key;
